...
def split_pdf_to_single_pages_command():
    ...
    status_label.config(text="已完成将多页 PDF 转换为单页")
...
pages_per_pdf_entry.insert(0, "10")

# 转换按钮
split_to_single_page_button = ttk.Button(root, text="Convert multi-page PDFs to single pages", command=split_pdf_to_single_pages_command)
split_to_single_page_button.grid(row=3, column=0, columnspan=3, padx=10, pady=10)

split_to_multiple_pdfs_button = ttk.Button(root, text="Split multi-page PDF into multiple PDF files", command=split_pdf_to_multiple_pdfs_command)
split_to_multiple_pdfs_button.grid(row=4, column=0, columnspan=3, padx=10, pady=10)

merge_pdfs_button = ttk.Button(root, text="Combine multiple PDF files into one PDF file", command=merge_pdfs_to_single_pdf_command)
merge_pdfs_button.grid(row=5, column=0, columnspan=3, padx=10, pady=10)
